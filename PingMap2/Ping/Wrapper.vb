...
Namespace Ping
    Public Class Wrapper : Implements IDisposable

        Private Shared ReadOnly Property _PAYLOAD As Byte() = {&HD, &HE, &HA, &HD, &HB, &HE, &HE, &HF}

        Public Event PingEvent As PingEventHandler

        Private _is_disposed As Boolean = False
        Private ReadOnly _ping As New NetworkInformation.Ping
