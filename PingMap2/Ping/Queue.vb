Namespace Ping
    Public Class PingQueue
        ...
        Private ReadOnly _pool As New Pool
        Private ReadOnly _results As New List(Of Result)
        ...
        Public ReadOnly Property Results As IEnumerable(Of Result)
            Get
                Return Me._results
            End Get
        End Property

        Public Sub New(requests As IEnumerable(Of Wrapper))
